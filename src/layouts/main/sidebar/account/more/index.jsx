...
export default function More({ close }) {
  ...
  return (
    <div>
      ...
      <button className="py-3 px-4 text-left transition-colors hover:bg-[#eff3f41a] w-full tex-[#e7e9ea] text-[15px] font-bold leading-[20px] ">
